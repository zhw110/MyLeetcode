...
class Person
{
	...
	// --------------------------------------------------------------
	public Person(final String last, final String first, final int a)
	{ // constructor
		lastName = last;
		firstName = first;
		age = a;
...
class ClassDataArray
{
	...
	public ClassDataArray(final int max) // constructor
	{
	...
	// --------------------------------------------------------------
	public Person find(final String searchName)
	...
	// --------------------------------------------------------------
	public boolean delete(final String searchName)
